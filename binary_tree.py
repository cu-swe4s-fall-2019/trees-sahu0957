...
def insert(root, key, value=None):
    if root == None:
        ...
        # if the root exists, it's time to check whether our key should go right
        ...
        if key < root.key:
            ...
            if root.left == None:
                ...
                # if the left is already occupied, it means we need to determine whether it goes left or
            ...
            if root.right == None:
                ...
                # if the right is already occupied, we need to determine whetherit goes right or
